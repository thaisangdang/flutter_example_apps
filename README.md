...
| 20 | [**Shopping Cart**](https://github.com/thaisangdang/flutter_shopping_cart) | An e-commerce concept using Global State.<br> **Concepts:** `Provider` Package, `ChangeNotifier`, `Consumer`, State Management across screens. |

## 📚 Level 3: The Connected App (APIs & Networking)
